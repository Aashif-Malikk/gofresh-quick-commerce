import { ArrowDown, ArrowDown2, DiscountShape, HambergerMenu, Location, User } from 'iconsax-react';
                    ...
                    <div className="flex h-full flex-col justify-between p-5">
                        <div className="space-y-6">
                            ...
                            <nav className="space-y-2">
                                <Link to="/vendor/dashboard" className="flex w-full items-center justify-between rounded-2xl border border-slate-200 bg-white px-3 py-3 text-left text-sm font-medium text-slate-800 transition hover:bg-emerald-50" onClick={() => setIsDrawerOpen(false)}>
                                    Deshboard
                                </Link>
                                <Link to="/vendor/orders" className="flex w-full items-center justify-between rounded-2xl border border-slate-200 bg-white px-3 py-3 text-left text-sm font-medium text-slate-800 transition hover:bg-emerald-50" onClick={() => setIsDrawerOpen(false)}>
                                    Orders
                                </Link>
                                <Link to="/vendor/products" className="flex w-full items-center justify-between rounded-2xl border border-slate-200 bg-white px-3 py-3 text-left text-sm font-medium text-slate-800 transition hover:bg-emerald-50" onClick={() => setIsDrawerOpen(false)}>
                                    Products
                                </Link>
                            </nav>
                        </div>
